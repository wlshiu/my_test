...
//=============================================================================
static watcher_attr_t       g_watcher_attr[2] = {{.is_running = 0,},};
...
static int
_create_job_ctxt(scheduler_job_t *pJob, uint8_t *pCtxt, int *pCtxt_len)
{
    snprintf((char*)pCtxt, *pCtxt_len, "@x%x, to: x%x\n", pJob->src_uid, *pJob->pDest_uid);
    return 0;
}

static int
_destroy_job_ctxt(scheduler_job_t *pJob, uint8_t *pCtxt, int *pCtxt_len)
{
    return 0;
}
//=============================================================================

...
// Event handlers
void on_press_down(Button *btn)
{
    generic_event_handler(btn, "Press Down");
}
void on_press_up(Button *btn)
{
    generic_event_handler(btn, "Press Up");
}
void on_single_click(Button *btn)
{
    generic_event_handler(btn, "Single Click");
}
void on_double_click(Button *btn)
{
    generic_event_handler(btn, "Double Click");
}
void on_long_press_start(Button *btn)
{
    generic_event_handler(btn, "Long Press Start");
}
void on_long_press_hold(Button *btn)
{
    generic_event_handler(btn, "Long Press Hold");
}
void on_press_repeat(Button *btn)
{
    generic_event_handler(btn, "Press Repeat");
}

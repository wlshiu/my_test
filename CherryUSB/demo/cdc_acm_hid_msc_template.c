...
#include "usbd_core.h"
    ...
    defined(CONFIG_ENABLE_USBD_MSC) && (CONFIG_ENABLE_USBD_MSC) && \
    defined(CONFIG_ENABLE_USBD_HID) && (CONFIG_ENABLE_USBD_HID)
...
#endif /* CONFIG_ENABLE_USBD_CDC && CONFIG_ENABLE_USBD_MSC && CONFIG_ENABLE_USBD_HID */

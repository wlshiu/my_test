...
#if defined(CONFIG_ENABLE_USBD_CDC) && (CONFIG_ENABLE_USBD_CDC) && defined(CONFIG_ENABLE_USBD_MSC) &&  (CONFIG_ENABLE_USBD_MSC)
...
#endif  /* CONFIG_ENABLE_USBD_CDC && CONFIG_ENABLE_USBD_MSC */

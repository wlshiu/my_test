...
void test_readAllRegister_should_return_all_reg_val_including_fpu_reg(void)
{
    ...
    for(i = 0; i < 17; i++)
    {
        if(i < 16)
        {
            if(i == 2)
                ...
                decodeFourByte_ExpectAndReturn(0x2001fffc, 0xfcff0120);
            else if(i == LR)    //LR
    ...
    gdbCreateMsgPacket_ExpectAndReturn("",
                                       "$#f5");

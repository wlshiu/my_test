...
void initFloatingPoint32DataProcessing()
{
    ...
    tabulateTable("01X111000X1", FloatingPointDataProcessing, VCVT,  createTableException(NO_EXCEPTION) );
    tabulateTable("01X11110XX1", FloatingPointDataProcessing, VCVTR,  createTableException(NO_EXCEPTION) );
    tabulateTable("01X111X1XX1", FloatingPointDataProcessing, VCVTT2,  createTableException(NO_EXCEPTION) );
}

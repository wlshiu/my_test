...
void placePCtoVectorTable(int exceptionReceived)
{
    ...
    {
        case Reset     :
            coreReg[PC] = vectorTable + RESET;
            break;
        case Nmi       :
            coreReg[PC] = vectorTable + NMI;
            break;
        case HardFault :
            coreReg[PC] = vectorTable + HARDFAULT;
            break;
        case MemManage :
            coreReg[PC] = vectorTable + MEMMANAGE;
            break;
        case BusFault  :
            coreReg[PC] = vectorTable + BUSFAULT;
            break;
        case UsageFault:
            coreReg[PC] = vectorTable + USAGEFAULT;
            break;
        case SVCall    :
            coreReg[PC] = vectorTable + SVCALL;
            break;
        case PendSV    :
            coreReg[PC] = vectorTable + PENDSV;
            break;
        case SysTick   :
            coreReg[PC] = vectorTable + SYSTICK;
            break;
        case Interrupt :
            coreReg[PC] = vectorTable + INTERRUPT;
            break;
